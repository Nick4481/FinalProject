...
registerUser.click();
    ...
    username.sendKeys("testUsername1849");
...
public void logIn(){
    ...
    usernameInput.sendKeys("testUsername1849");
...
WebElement succesLogin = driver.findElement(By.className("title"));
String expectedMessage ="Accounts Overview";
String actualMessage = succesLogin.getText();
Assert.assertTrue(actualMessage.contains(expectedMessage));
